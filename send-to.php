...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function send_it()
		{
			...
			email_list_exclude = $form.find('select#email_list_exclude').val(),
			...
			$.post(url, { campaign_id: campaign_id, email_list: email_list, email_list_exclude: email_list_exclude, app: uid, cron: cron, total_recipients: total_recipients },
			  function(data) {
